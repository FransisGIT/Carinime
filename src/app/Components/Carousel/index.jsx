                        ...
                        <div className="absolute inset-0 bg-black bg-opacity-50">
                            <div className="absolute bottom-0 left-0 p-4 w-full">
                                <div className="text-white">
                                    <h3 className="text-3xl font-outline-1 md:text-5xl lg:text-5xl font-normal">{data.title}</h3>
                                    <p className="text-2xl md:text-lg mt-2 lg:text-3xl font-normal">The best top anime</p>
                                </div>
                            </div>
                        </div>
                    </div>

            ...
            <div className="pb-10">
                ...
                <div className="flex flex-col col-span-2 lg:flex-row m-5 gap-5">
                    ...
                    <div className="flex-none lg:max-w-[80%]">
                        <h1 className="lg:text-3xl md:text-3xl sm:text-3xl text-3xl font-normal text-white mb-5 hover:text-shadow-lg hover:shadow-indigo-500 transition-all duration-300 lg:flex lg:justify-start text-center">{detailAnime.data.title}</h1>
                        ...
                        <div className="my-3">
                            <p className="text-white hover:text-shadow-lg hover:shadow-indigo-500 transition-all duration-300 text-2xl mb-2 font-normal">Synopsis</p>
                            <p className=" text-white hover:text-shadow-lg hover:shadow-indigo-500 transition-all duration-300 text-base font-normal">{detailAnime.data.synopsis}</p>
                        </div>

                        {detailAnime?.data?.trailer?.embed_url ? (
                            <div className="my-3">
                                <p className="text-white hover:text-shadow-lg hover:shadow-indigo-500 transition-all duration-300 text-2xl mb-2 font-normal">Trailer</p>
                ...
                <div className="flex flex-col col-span-2 lg:flex-row m-5 gap-5 mt-10">
                    <div className="flex-none lg:w-[20%] md:w-full w-full">
                        <div className="bg-blue-navy rounded-[18px] py-3">
                            <p className="text-white hover:text-shadow-lg hover:shadow-indigo-500 transition-all duration-300 text-lg m-5 font-normal">Detail Anime</p>
                            <div className="flex flex-row lg:flex-wrap lg:flex-col flex-initial overflow-x-auto m-5 gap-3">
                                <div className="font-normal text-base lg:text-lg text-white whitespace-nowrap lg:whitespace-normal">
                                    Rating <br />
                                    <span className="font-light text-white text-sm lg:text-lg font-normal">{detailAnime.data.rating}</span>
                                </div>
                                <div className="font-normal text-base lg:text-lg text-white whitespace-nowrap lg:whitespace-normal">
                                    Format <br />
                                    <span className="font-light text-white text-base lg:text-lg font-normal">{detailAnime.data.type}</span>
                                </div>
                                <div className="font-normal text-base lg:text-lg text-white whitespace-nowrap lg:whitespace-normal">
                                    Episodes <br />
                                    <span className="font-light text-white text-base lg:text-lg font-normal">{detailAnime.data.episodes}</span>
                                </div>
                                <div className="font-normal text-base lg:text-lg text-white whitespace-nowrap lg:whitespace-normal">
                                    Episode Duration <br />
                                    <span className="font-light text-white text-base lg:text-lg font-normal">{detailAnime.data.duration}</span>
                                </div>
                                <div className="font-normal text-base lg:text-lg text-white whitespace-nowrap lg:whitespace-normal">
                                    Status <br />
                                    <span className="font-light text-white text-base lg:text-lg font-normal">{detailAnime.data.status}</span>
                                </div>
                                <div className="font-normal text-base lg:text-lg text-white whitespace-nowrap lg:whitespace-normal">
                                    Aired <br />
                                    <span className="font-light text-white text-base lg:text-lg font-normal">{detailAnime.data.aired?.string}</span>
                                </div>
                                <div className="font-normal text-base lg:text-lg text-white whitespace-nowrap lg:whitespace-normal">
                                    Season <br />
                                    <span className="font-light text-white text-base lg:text-lg font-normal">{detailAnime.data.season}</span>
                                </div>
                                <div className="font-normal text-base lg:text-lg text-white whitespace-nowrap lg:whitespace-normal">
                                    Studios <br />
                                    <span className="font-light text-white text-base lg:text-lg font-normal">{detailAnime.data.studios?.[0].name}</span>
                                </div>
                                ...
                                <div className="font-normal text-base lg:text-lg text-white whitespace-nowrap lg:whitespace-normal">
                                    Title Japanese <br />
                                    <span className="font-light text-white text-sm lg:text-lg font-normal">{detailAnime.data.title_japanese}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="flex-initial lg:max-w-[80%]">
                        <div className="flex flex-col col-span-2 lg:flex-row gap-5">
                            <div>
                                {detailChar.data ? (
                                    <div>
                                        <p className="text-white hover:text-shadow-lg hover:shadow-indigo-500 transition-all duration-300 text-lg m-5 font-normal">
                                                        ...
                                                        <Link href={char.character.url}>
                                                            <div className="flex items-center gap-4">
                                                                ...
                                                                <div className="text-start">
                                                                    <p className="font-normal hover:text-sky-600 text-white lg:text-lg text-sm">
                                                                        {char.character?.name || 'Unknown Character'}
                                                                    </p>
                                                                    <p className="text-base font-normal text-gray-300">{char.role || 'Unknown Role'}</p>
                                                                </div>
                                                            </div>
                                                        </Link>
                                                        ...
                                                        <Link href={japaneseVoiceActor.person.url}>
                                                            <div className="flex items-center gap-4">
                                                                <div className="text-end">
                                                                    ...
                                                                    <p className="text-base font-normal text-gray-300">{japaneseVoiceActor.language || 'Unknown'}</p>
                                                                </div>
